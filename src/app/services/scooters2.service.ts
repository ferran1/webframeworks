...
export class Scooters2Service {
  private scooters: Scooter[];

  private readonly DB_URL = "https://webframeworksdb.firebaseio.com/";
  private readonly DB_URL_SCOOTERS = 'https://webframeworksdb.firebaseio.com/Scooter.json';
  ...
  add(EScooter: Scooter){
    ...
    getAllScooters() {
      return this.httpClient.get<Scooter[]>(this.DB_URL_SCOOTERS).subscribe(
        (data: Scooter[]) => {
          console.log(data);
          data.map(o => {o ? this.scooters.push(o) : []});
