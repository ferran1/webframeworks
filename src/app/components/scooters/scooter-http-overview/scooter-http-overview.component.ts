...
@Component({
  selector: 'app-scooter-http-overview',
  templateUrl: './scooter-http-overview.component.html',
  styleUrls: ['./scooter-http-overview.component.css']
})
export class ScooterHttpOverviewComponent implements OnInit {
  ...
  constructor(private scooterService: Scooters2Service, private router: Router, private activatedRoute: ActivatedRoute) {
